...
const teamMembers = [
  {
    name: 'Sruthi',
    photo: '/images/member6.jpg', // Replace with actual image path
    role: 'Frontend developer'
  },
  {
    name: 'Farhan',
    photo: '/images/member2.jpg', // Replace with actual image path
    role: 'Backend developer'
  },
  {
    name: 'Akhila',
    photo: '/images/member3.jpg', // Replace with actual image path
    role: 'Database Engineer'
  },
    {
        name: 'Shiva',
        photo: '/images/member4.jpg', // Replace with actual image path
        role: 'Cloud Engineer'
    },
    {
        name: 'Farhana',
        photo: '/images/member5.jpg', // Replace with actual image path
        role: 'Project Planning'
    },
    {
        name: 'Vandana',
        photo: '/images/member1.jpg', // Replace with actual image path
        role: 'Frontend developer'
    },
];
