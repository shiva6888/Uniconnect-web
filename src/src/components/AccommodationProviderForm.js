...
import { FormControlLabel, Checkbox, Typography, Button, Grid } from '@mui/material';
  ...
  return (
    <form onSubmit={handleSubmit}>
      <Grid container spacing={2}>
        ...
        <Grid item xs={12}><FormTextField label="Business Name" name="businessName" value={formData.businessName} onChange={handleChange} required error={errors.businessName} helperText={errors.businessName} /></Grid>
