        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} sm={6} md={4}>
            ...
            <Typography variant="body2" paragraph>
              <Link component={RouterLink} to="/about" color="inherit" underline="hover" display="block" sx={{ mb: 1 }}>About Us</Link>
              <Link component={RouterLink} to="/login" color="inherit" underline="hover" display="block" sx={{ mb: 1 }}>Login</Link>
              <Link component={RouterLink} to="/contact" color="inherit" underline="hover" display="block" sx={{ mb: 1 }}>Contact Us</Link>
          ...
          <Grid item xs={12} sm={6} md={3}>
            ...
            <Typography variant="body2" paragraph>
              ...
              <Link href="#" color="inherit" underline="hover" display="block" sx={{ mb: 1 }}>Review</Link>
              <Link href="#" color="inherit" underline="hover" display="block">Contact Us</Link>
            </Typography>
          </Grid>
        </Grid>
        <Typography variant="body2" color="text.secondary" align="center" sx={{ mt: 4 }}>
          © {currentYear} UniConnect. All rights reserved.
        </Typography>
      </Container>
    </Box>
  );
